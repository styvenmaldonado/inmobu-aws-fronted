const Lang = () => {
    ...
    <div class="menuItem flex list-none items-center text-right pr-10 h-full">
                <div class="flex text-left items-center h-16 pl-2">
                    <div>
                        <button class="border-none bg-transparent h-16 rounded-2xl">
                ...
                <div class="dropdown-content hidden w-full shadow-2xl px-16 py-12 bg-white border-t border-gray-200 ">
                            <div class="w-2/5"><div class="text-3xl font-bold pb-3 text-left">Elige un idioma</div>
                                <ul class="list-none flex pl-0">
                                    <li class=" pr-6 text-blue-500">Español</li>
                                    <li class="pr-6">English</li>
                                    <li class="pr-6">Portugues</li>
                                </ul>
                            </div>
                            <div><div class="text-3xl font-bold pb-3 text-left">Elige una región/pais</div>
                                <ul class="flex pl-0 list-none flex-wrap">
                                    <li class="pr-6 text-blue-500""> Colombia</li>
                                    <li class="pr-6">Brasil</li>
                                    <li class="pr-6">Argentina</li>
                                    <li class="pr-6">México</li>
                                    <li class="pr-6">Costa Rica</li>
                                    <li class="pr-6">Panama</li>
                                    <li class="pr-6">Venezuela</li>
                                    <li class="pr-6">Chile</li>
                                    <li class="pr-6">Estados Unidos</li>
                                    <li class="pr-6">Canada</li>
                                    <li class="pr-6">España</li>
                                    <li class="pr-6">Francia</li>
                                </ul>
                            </div>
